...
#> INFO    [2026-09-02 20:31:49] Running RunPCA (npcs=50, dims=1:30) ...
...
#> INFO    [2026-09-02 20:31:50] Running FindNeighbors (reduction=pca) ...
#> Computing nearest neighbor graph
#> Computing SNN
#> INFO    [2026-09-02 20:31:52] Running FindClusters ...
#> INFO    [2026-09-02 20:31:52]   applying resolution: 0.8
...
#> INFO    [2026-09-02 20:31:53]   Found clusters (with resolution 0.8):
#> INFO    [2026-09-02 20:31:53]    | c1(44), c2(36)
#> INFO    [2026-09-02 20:31:53] Running RunUMAP ...
#> INFO    [2026-09-02 20:31:53]   reduction=pca, dims=1:19, umap.method=uwot, n.neighbors=30
#> Warning: The default method for RunUMAP has changed from calling Python UMAP via reticulate to the R-native UWOT using the cosine metric
#> To use Python UMAP via reticulate, set umap.method to 'umap-learn' and metric to 'correlation'
#> This message will be shown once per session
#> 20:31:53 UMAP embedding parameters a = 0.9922 b = 1.112
#> 20:31:53 Read 80 rows and found 19 numeric columns
#> 20:31:53 Using Annoy for neighbor search, n_neighbors = 30
#> 20:31:53 Building Annoy index with metric = cosine, n_trees = 50
...
#> *
#> |
#> 20:31:53 Writing NN index file to temp file /tmp/RtmpY5IBqT/file2b73372e99fa
#> 20:31:53 Searching Annoy index using 1 thread, search_k = 3000
#> 20:31:53 Annoy recall = 100%
#> 20:31:54 Commencing smooth kNN distance calibration using 1 thread
#>  with target n_neighbors = 30
#> 20:31:54 7 smooth knn distance failures
#> 20:31:56 Initializing from normalized Laplacian + noise (using RSpectra)
#> 20:31:56 Commencing optimization for 500 epochs, with 2664 positive edges
#> 20:31:56 Using rng type: pcg
#> 20:31:57 Optimization finished
