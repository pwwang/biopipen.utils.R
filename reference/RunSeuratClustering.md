...
#> INFO    [2026-03-30 21:23:20] Running RunPCA (npcs=50, dims=1:30) ...
...
#> INFO    [2026-03-30 21:23:21] Running FindNeighbors (reduction=pca) ...
#> Computing nearest neighbor graph
#> Computing SNN
#> INFO    [2026-03-30 21:23:22] Running FindClusters ...
#> INFO    [2026-03-30 21:23:22]   applying resolution: 0.8
...
#> INFO    [2026-03-30 21:23:22]   Found clusters (with resolution 0.8):
#> INFO    [2026-03-30 21:23:22]    | c1(44), c2(36)
#> INFO    [2026-03-30 21:23:23] Running RunUMAP ...
#> INFO    [2026-03-30 21:23:23]   reduction=pca, dims=1:19, umap.method=uwot, n.neighbors=30
#> Warning: The default method for RunUMAP has changed from calling Python UMAP via reticulate to the R-native UWOT using the cosine metric
#> To use Python UMAP via reticulate, set umap.method to 'umap-learn' and metric to 'correlation'
#> This message will be shown once per session
#> 21:23:23 UMAP embedding parameters a = 0.9922 b = 1.112
#> 21:23:23 Read 80 rows and found 19 numeric columns
#> 21:23:23 Using Annoy for neighbor search, n_neighbors = 30
#> 21:23:23 Building Annoy index with metric = cosine, n_trees = 50
...
#> *
#> |
#> 21:23:23 Writing NN index file to temp file /tmp/RtmpVHOWtJ/file8db45cabaf75
#> 21:23:23 Searching Annoy index using 1 thread, search_k = 3000
#> 21:23:23 Annoy recall = 100%
#> 21:23:23 Commencing smooth kNN distance calibration using 1 thread
#>  with target n_neighbors = 30
#> 21:23:23 7 smooth knn distance failures
#> 21:23:25 Initializing from normalized Laplacian + noise (using RSpectra)
#> 21:23:25 Commencing optimization for 500 epochs, with 2664 positive edges
#> 21:23:25 Using rng type: pcg
#> 21:23:25 Optimization finished
