...
#> INFO    [2025-12-04 16:18:10] Running RunPCA ...
...
#> INFO    [2025-12-04 16:18:10] Running FindNeighbors ...
#> Computing nearest neighbor graph
#> Computing SNN
#> INFO    [2025-12-04 16:18:11] Running FindClusters ...
#> INFO    [2025-12-04 16:18:12]   Using resolution(s): 0.8
...
#> INFO    [2025-12-04 16:18:12]   Found clusters (with resolution 0.8):
#> INFO    [2025-12-04 16:18:12]    | c1(44), c2(36)
#> INFO    [2025-12-04 16:18:12] Running RunUMAP ...
#> Warning: The default method for RunUMAP has changed from calling Python UMAP via reticulate to the R-native UWOT using the cosine metric
#> To use Python UMAP via reticulate, set umap.method to 'umap-learn' and metric to 'correlation'
#> This message will be shown once per session
#> 16:18:12 UMAP embedding parameters a = 0.9922 b = 1.112
#> 16:18:12 Read 80 rows and found 19 numeric columns
#> 16:18:12 Using Annoy for neighbor search, n_neighbors = 30
#> 16:18:12 Building Annoy index with metric = cosine, n_trees = 50
...
#> *
#> |
#> 16:18:12 Writing NN index file to temp file /tmp/RtmpjLSR4w/file254d2860c5d3
#> 16:18:12 Searching Annoy index using 1 thread, search_k = 3000
#> 16:18:12 Annoy recall = 100%
#> 16:18:13 Commencing smooth kNN distance calibration using 1 thread
#>  with target n_neighbors = 30
#> 16:18:13 7 smooth knn distance failures
#> 16:18:14 Initializing from normalized Laplacian + noise (using RSpectra)
#> 16:18:14 Commencing optimization for 500 epochs, with 2664 positive edges
#> 16:18:14 Using rng type: pcg
#> 16:18:15 Optimization finished
