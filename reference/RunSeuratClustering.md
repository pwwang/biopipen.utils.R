...
#> INFO    [2025-12-05 07:19:18] Running RunPCA ...
...
#> INFO    [2025-12-05 07:19:19] Running FindNeighbors ...
#> Computing nearest neighbor graph
#> Computing SNN
#> INFO    [2025-12-05 07:19:20] Running FindClusters ...
#> INFO    [2025-12-05 07:19:20]   Using resolution(s): 0.8
...
#> INFO    [2025-12-05 07:19:21]   Found clusters (with resolution 0.8):
#> INFO    [2025-12-05 07:19:21]    | c1(44), c2(36)
#> INFO    [2025-12-05 07:19:21] Running RunUMAP ...
#> Warning: The default method for RunUMAP has changed from calling Python UMAP via reticulate to the R-native UWOT using the cosine metric
#> To use Python UMAP via reticulate, set umap.method to 'umap-learn' and metric to 'correlation'
#> This message will be shown once per session
#> 07:19:21 UMAP embedding parameters a = 0.9922 b = 1.112
#> 07:19:21 Read 80 rows and found 19 numeric columns
#> 07:19:21 Using Annoy for neighbor search, n_neighbors = 30
#> 07:19:21 Building Annoy index with metric = cosine, n_trees = 50
...
#> *
#> |
#> 07:19:21 Writing NN index file to temp file /tmp/Rtmpo4GTUb/file25381ed34f65
#> 07:19:21 Searching Annoy index using 1 thread, search_k = 3000
#> 07:19:21 Annoy recall = 100%
#> 07:19:22 Commencing smooth kNN distance calibration using 1 thread
#>  with target n_neighbors = 30
#> 07:19:22 7 smooth knn distance failures
#> 07:19:23 Initializing from normalized Laplacian + noise (using RSpectra)
#> 07:19:23 Commencing optimization for 500 epochs, with 2664 positive edges
#> 07:19:23 Using rng type: pcg
#> 07:19:24 Optimization finished
