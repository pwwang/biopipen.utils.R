...
#> INFO    [2026-09-06 04:56:56] Running RunPCA (npcs=50, dims=1:30) ...
...
#> INFO    [2026-09-06 04:56:58] Running FindNeighbors (reduction=pca) ...
#> Computing nearest neighbor graph
#> Computing SNN
#> INFO    [2026-09-06 04:56:59] Running FindClusters ...
#> INFO    [2026-09-06 04:56:59]   applying resolution: 0.8
...
#> INFO    [2026-09-06 04:57:00]   Found clusters (with resolution 0.8):
#> INFO    [2026-09-06 04:57:00]    | c1(44), c2(36)
#> INFO    [2026-09-06 04:57:00] Running RunUMAP ...
#> INFO    [2026-09-06 04:57:00]   reduction=pca, dims=1:19, umap.method=uwot, n.neighbors=30
#> Warning: The default method for RunUMAP has changed from calling Python UMAP via reticulate to the R-native UWOT using the cosine metric
#> To use Python UMAP via reticulate, set umap.method to 'umap-learn' and metric to 'correlation'
#> This message will be shown once per session
#> 04:57:00 UMAP embedding parameters a = 0.9922 b = 1.112
#> 04:57:00 Read 80 rows and found 19 numeric columns
#> 04:57:00 Using Annoy for neighbor search, n_neighbors = 30
#> 04:57:00 Building Annoy index with metric = cosine, n_trees = 50
...
#> *
#> |
#> 04:57:00 Writing NN index file to temp file /tmp/RtmpRIvMS9/file284c760ae93a
#> 04:57:00 Searching Annoy index using 1 thread, search_k = 3000
#> 04:57:00 Annoy recall = 100%
#> 04:57:01 Commencing smooth kNN distance calibration using 1 thread
#>  with target n_neighbors = 30
#> 04:57:01 7 smooth knn distance failures
#> 04:57:02 Initializing from normalized Laplacian + noise (using RSpectra)
#> 04:57:02 Commencing optimization for 500 epochs, with 2664 positive edges
#> 04:57:02 Using rng type: pcg
#> 04:57:03 Optimization finished
