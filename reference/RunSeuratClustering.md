...
#> INFO    [2026-07-21 07:31:38] Running RunPCA (npcs=50, dims=1:30) ...
...
#> INFO    [2026-07-21 07:31:39] Running FindNeighbors (reduction=pca) ...
#> Computing nearest neighbor graph
#> Computing SNN
#> INFO    [2026-07-21 07:31:40] Running FindClusters ...
#> INFO    [2026-07-21 07:31:40]   applying resolution: 0.8
...
#> INFO    [2026-07-21 07:31:41]   Found clusters (with resolution 0.8):
#> INFO    [2026-07-21 07:31:41]    | c1(44), c2(36)
#> INFO    [2026-07-21 07:31:41] Running RunUMAP ...
#> INFO    [2026-07-21 07:31:41]   reduction=pca, dims=1:19, umap.method=uwot, n.neighbors=30
#> Warning: The default method for RunUMAP has changed from calling Python UMAP via reticulate to the R-native UWOT using the cosine metric
#> To use Python UMAP via reticulate, set umap.method to 'umap-learn' and metric to 'correlation'
#> This message will be shown once per session
#> 07:31:41 UMAP embedding parameters a = 0.9922 b = 1.112
#> 07:31:41 Read 80 rows and found 19 numeric columns
#> 07:31:41 Using Annoy for neighbor search, n_neighbors = 30
#> 07:31:41 Building Annoy index with metric = cosine, n_trees = 50
...
#> *
#> |
#> 07:31:41 Writing NN index file to temp file /tmp/RtmpVSQ347/file907c256a6ad0
#> 07:31:41 Searching Annoy index using 1 thread, search_k = 3000
#> 07:31:41 Annoy recall = 100%
#> 07:31:42 Commencing smooth kNN distance calibration using 1 thread
#>  with target n_neighbors = 30
#> 07:31:42 7 smooth knn distance failures
#> 07:31:43 Initializing from normalized Laplacian + noise (using RSpectra)
#> 07:31:43 Commencing optimization for 500 epochs, with 2664 positive edges
#> 07:31:43 Using rng type: pcg
#> 07:31:44 Optimization finished
