...
#> INFO    [2025-12-04 21:19:33] Running RunPCA ...
...
#> INFO    [2025-12-04 21:19:34] Running FindNeighbors ...
#> Computing nearest neighbor graph
#> Computing SNN
#> INFO    [2025-12-04 21:19:35] Running FindClusters ...
#> INFO    [2025-12-04 21:19:36]   Using resolution(s): 0.8
...
#> INFO    [2025-12-04 21:19:36]   Found clusters (with resolution 0.8):
#> INFO    [2025-12-04 21:19:36]    | c1(44), c2(36)
#> INFO    [2025-12-04 21:19:36] Running RunUMAP ...
#> Warning: The default method for RunUMAP has changed from calling Python UMAP via reticulate to the R-native UWOT using the cosine metric
#> To use Python UMAP via reticulate, set umap.method to 'umap-learn' and metric to 'correlation'
#> This message will be shown once per session
#> 21:19:36 UMAP embedding parameters a = 0.9922 b = 1.112
#> 21:19:36 Read 80 rows and found 19 numeric columns
#> 21:19:36 Using Annoy for neighbor search, n_neighbors = 30
#> 21:19:36 Building Annoy index with metric = cosine, n_trees = 50
...
#> *
#> |
#> 21:19:36 Writing NN index file to temp file /tmp/RtmpSrwoZS/file254719cde15c
#> 21:19:36 Searching Annoy index using 1 thread, search_k = 3000
#> 21:19:36 Annoy recall = 100%
#> 21:19:37 Commencing smooth kNN distance calibration using 1 thread
#>  with target n_neighbors = 30
#> 21:19:37 7 smooth knn distance failures
#> 21:19:38 Initializing from normalized Laplacian + noise (using RSpectra)
#> 21:19:38 Commencing optimization for 500 epochs, with 2664 positive edges
#> 21:19:38 Using rng type: pcg
#> 21:19:39 Optimization finished
