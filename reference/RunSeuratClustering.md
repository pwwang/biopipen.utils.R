...
#> INFO    [2026-04-07 15:48:42] Running RunPCA (npcs=50, dims=1:30) ...
...
#> INFO    [2026-04-07 15:48:43] Running FindNeighbors (reduction=pca) ...
#> Computing nearest neighbor graph
#> Computing SNN
#> INFO    [2026-04-07 15:48:44] Running FindClusters ...
#> INFO    [2026-04-07 15:48:44]   applying resolution: 0.8
...
#> INFO    [2026-04-07 15:48:45]   Found clusters (with resolution 0.8):
#> INFO    [2026-04-07 15:48:45]    | c1(44), c2(36)
#> INFO    [2026-04-07 15:48:45] Running RunUMAP ...
#> INFO    [2026-04-07 15:48:45]   reduction=pca, dims=1:19, umap.method=uwot, n.neighbors=30
#> Warning: The default method for RunUMAP has changed from calling Python UMAP via reticulate to the R-native UWOT using the cosine metric
#> To use Python UMAP via reticulate, set umap.method to 'umap-learn' and metric to 'correlation'
#> This message will be shown once per session
#> 15:48:45 UMAP embedding parameters a = 0.9922 b = 1.112
#> 15:48:45 Read 80 rows and found 19 numeric columns
#> 15:48:45 Using Annoy for neighbor search, n_neighbors = 30
#> 15:48:45 Building Annoy index with metric = cosine, n_trees = 50
...
#> *
#> |
#> 15:48:45 Writing NN index file to temp file /tmp/RtmpWEDibc/file296552e63361
#> 15:48:45 Searching Annoy index using 1 thread, search_k = 3000
#> 15:48:45 Annoy recall = 100%
#> 15:48:46 Commencing smooth kNN distance calibration using 1 thread
#>  with target n_neighbors = 30
#> 15:48:46 7 smooth knn distance failures
#> 15:48:47 Initializing from normalized Laplacian + noise (using RSpectra)
#> 15:48:47 Commencing optimization for 500 epochs, with 2664 positive edges
#> 15:48:47 Using rng type: pcg
#> 15:48:48 Optimization finished
