...
#> INFO    [2025-12-04 20:54:11] Running RunPCA ...
...
#> INFO    [2025-12-04 20:54:12] Running FindNeighbors ...
#> Computing nearest neighbor graph
#> Computing SNN
#> INFO    [2025-12-04 20:54:13] Running FindClusters ...
#> INFO    [2025-12-04 20:54:13]   Using resolution(s): 0.8
...
#> INFO    [2025-12-04 20:54:14]   Found clusters (with resolution 0.8):
#> INFO    [2025-12-04 20:54:14]    | c1(44), c2(36)
#> INFO    [2025-12-04 20:54:14] Running RunUMAP ...
#> Warning: The default method for RunUMAP has changed from calling Python UMAP via reticulate to the R-native UWOT using the cosine metric
#> To use Python UMAP via reticulate, set umap.method to 'umap-learn' and metric to 'correlation'
#> This message will be shown once per session
#> 20:54:14 UMAP embedding parameters a = 0.9922 b = 1.112
#> 20:54:14 Read 80 rows and found 19 numeric columns
#> 20:54:14 Using Annoy for neighbor search, n_neighbors = 30
#> 20:54:14 Building Annoy index with metric = cosine, n_trees = 50
...
#> *
#> |
#> 20:54:14 Writing NN index file to temp file /tmp/Rtmp5bG5z5/file25105c395327
#> 20:54:14 Searching Annoy index using 1 thread, search_k = 3000
#> 20:54:14 Annoy recall = 100%
#> 20:54:15 Commencing smooth kNN distance calibration using 1 thread
#>  with target n_neighbors = 30
#> 20:54:15 7 smooth knn distance failures
#> 20:54:16 Initializing from normalized Laplacian + noise (using RSpectra)
#> 20:54:16 Commencing optimization for 500 epochs, with 2664 positive edges
#> 20:54:16 Using rng type: pcg
#> 20:54:17 Optimization finished
