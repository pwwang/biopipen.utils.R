...
#> INFO    [2026-05-13 02:04:41] Running RunPCA (npcs=50, dims=1:30) ...
...
#> INFO    [2026-05-13 02:04:42] Running FindNeighbors (reduction=pca) ...
#> Computing nearest neighbor graph
#> Computing SNN
#> INFO    [2026-05-13 02:04:44] Running FindClusters ...
#> INFO    [2026-05-13 02:04:44]   applying resolution: 0.8
...
#> INFO    [2026-05-13 02:04:44]   Found clusters (with resolution 0.8):
#> INFO    [2026-05-13 02:04:44]    | c1(44), c2(36)
#> INFO    [2026-05-13 02:04:44] Running RunUMAP ...
#> INFO    [2026-05-13 02:04:44]   reduction=pca, dims=1:19, umap.method=uwot, n.neighbors=30
#> Warning: The default method for RunUMAP has changed from calling Python UMAP via reticulate to the R-native UWOT using the cosine metric
#> To use Python UMAP via reticulate, set umap.method to 'umap-learn' and metric to 'correlation'
#> This message will be shown once per session
#> 02:04:44 UMAP embedding parameters a = 0.9922 b = 1.112
#> 02:04:44 Read 80 rows and found 19 numeric columns
#> 02:04:44 Using Annoy for neighbor search, n_neighbors = 30
#> 02:04:44 Building Annoy index with metric = cosine, n_trees = 50
...
#> *
#> |
#> 02:04:44 Writing NN index file to temp file /tmp/RtmpJRknWw/file93441bc6ee2
#> 02:04:44 Searching Annoy index using 1 thread, search_k = 3000
#> 02:04:44 Annoy recall = 100%
#> 02:04:45 Commencing smooth kNN distance calibration using 1 thread
#>  with target n_neighbors = 30
#> 02:04:45 7 smooth knn distance failures
#> 02:04:47 Initializing from normalized Laplacian + noise (using RSpectra)
#> 02:04:47 Commencing optimization for 500 epochs, with 2664 positive edges
#> 02:04:47 Using rng type: pcg
#> 02:04:48 Optimization finished
