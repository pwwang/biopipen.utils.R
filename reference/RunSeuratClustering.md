...
#> INFO    [2025-12-03 23:26:04] Running RunPCA ...
...
#> INFO    [2025-12-03 23:26:05] Running FindNeighbors ...
#> Computing nearest neighbor graph
#> Computing SNN
#> INFO    [2025-12-03 23:26:06] Running FindClusters ...
#> INFO    [2025-12-03 23:26:06]   Using resolution(s): 0.8
...
#> INFO    [2025-12-03 23:26:06]   Found clusters (with resolution 0.8):
#> INFO    [2025-12-03 23:26:06]    | c1(44), c2(36)
#> INFO    [2025-12-03 23:26:06] Running RunUMAP ...
#> Warning: The default method for RunUMAP has changed from calling Python UMAP via reticulate to the R-native UWOT using the cosine metric
#> To use Python UMAP via reticulate, set umap.method to 'umap-learn' and metric to 'correlation'
#> This message will be shown once per session
#> 23:26:07 UMAP embedding parameters a = 0.9922 b = 1.112
#> 23:26:07 Read 80 rows and found 19 numeric columns
#> 23:26:07 Using Annoy for neighbor search, n_neighbors = 30
#> 23:26:07 Building Annoy index with metric = cosine, n_trees = 50
...
#> *
#> |
#> 23:26:07 Writing NN index file to temp file /tmp/RtmpnnQQz0/file24c242101515
#> 23:26:07 Searching Annoy index using 1 thread, search_k = 3000
#> 23:26:07 Annoy recall = 100%
#> 23:26:07 Commencing smooth kNN distance calibration using 1 thread
#>  with target n_neighbors = 30
#> 23:26:07 7 smooth knn distance failures
#> 23:26:09 Initializing from normalized Laplacian + noise (using RSpectra)
#> 23:26:09 Commencing optimization for 500 epochs, with 2664 positive edges
#> 23:26:09 Using rng type: pcg
#> 23:26:09 Optimization finished
