...
#> INFO    [2025-12-05 16:06:05] Running RunPCA ...
...
#> INFO    [2025-12-05 16:06:06] Running FindNeighbors ...
#> Computing nearest neighbor graph
#> Computing SNN
#> INFO    [2025-12-05 16:06:07] Running FindClusters ...
#> INFO    [2025-12-05 16:06:07]   Using resolution(s): 0.8
...
#> INFO    [2025-12-05 16:06:07]   Found clusters (with resolution 0.8):
#> INFO    [2025-12-05 16:06:07]    | c1(44), c2(36)
#> INFO    [2025-12-05 16:06:07] Running RunUMAP ...
#> Warning: The default method for RunUMAP has changed from calling Python UMAP via reticulate to the R-native UWOT using the cosine metric
#> To use Python UMAP via reticulate, set umap.method to 'umap-learn' and metric to 'correlation'
#> This message will be shown once per session
#> 16:06:07 UMAP embedding parameters a = 0.9922 b = 1.112
#> 16:06:07 Read 80 rows and found 19 numeric columns
#> 16:06:07 Using Annoy for neighbor search, n_neighbors = 30
#> 16:06:07 Building Annoy index with metric = cosine, n_trees = 50
...
#> *
#> |
#> 16:06:07 Writing NN index file to temp file /tmp/Rtmp175EyC/file250225a61898
#> 16:06:07 Searching Annoy index using 1 thread, search_k = 3000
#> 16:06:07 Annoy recall = 100%
#> 16:06:08 Commencing smooth kNN distance calibration using 1 thread
#>  with target n_neighbors = 30
#> 16:06:08 7 smooth knn distance failures
#> 16:06:09 Initializing from normalized Laplacian + noise (using RSpectra)
#> 16:06:09 Commencing optimization for 500 epochs, with 2664 positive edges
#> 16:06:09 Using rng type: pcg
#> 16:06:10 Optimization finished
