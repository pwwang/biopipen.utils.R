...
#> INFO    [2026-04-04 05:58:27] Running RunPCA (npcs=50, dims=1:30) ...
...
#> INFO    [2026-04-04 05:58:28] Running FindNeighbors (reduction=pca) ...
#> Computing nearest neighbor graph
#> Computing SNN
#> INFO    [2026-04-04 05:58:29] Running FindClusters ...
#> INFO    [2026-04-04 05:58:29]   applying resolution: 0.8
...
#> INFO    [2026-04-04 05:58:30]   Found clusters (with resolution 0.8):
#> INFO    [2026-04-04 05:58:30]    | c1(44), c2(36)
#> INFO    [2026-04-04 05:58:30] Running RunUMAP ...
#> INFO    [2026-04-04 05:58:30]   reduction=pca, dims=1:19, umap.method=uwot, n.neighbors=30
#> Warning: The default method for RunUMAP has changed from calling Python UMAP via reticulate to the R-native UWOT using the cosine metric
#> To use Python UMAP via reticulate, set umap.method to 'umap-learn' and metric to 'correlation'
#> This message will be shown once per session
#> 05:58:30 UMAP embedding parameters a = 0.9922 b = 1.112
#> 05:58:30 Read 80 rows and found 19 numeric columns
#> 05:58:30 Using Annoy for neighbor search, n_neighbors = 30
#> 05:58:30 Building Annoy index with metric = cosine, n_trees = 50
...
#> *
#> |
#> 05:58:30 Writing NN index file to temp file /tmp/Rtmpk2SzQl/file28c76455bcb6
#> 05:58:30 Searching Annoy index using 1 thread, search_k = 3000
#> 05:58:30 Annoy recall = 100%
#> 05:58:31 Commencing smooth kNN distance calibration using 1 thread
#>  with target n_neighbors = 30
#> 05:58:31 7 smooth knn distance failures
#> 05:58:32 Initializing from normalized Laplacian + noise (using RSpectra)
#> 05:58:32 Commencing optimization for 500 epochs, with 2664 positive edges
#> 05:58:32 Using rng type: pcg
#> 05:58:33 Optimization finished
